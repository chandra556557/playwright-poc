...
test.describe('E-commerce Login Flow', () => {
  ...
  test('Valid Login Test', async ({ page }) => {
    console.log('🧪 Starting test: Valid Login Test');
    
    // Navigate to the page
    await page.goto('undefined', { waitUntil: 'networkidle' });
    

    // Step 1: undefined - https://demo.opencart.com/index.php?route=account/login
    console.log('⚠️ Unknown step type: undefined');

    // Step 2: undefined - #input-email
    console.log('⚠️ Unknown step type: undefined');

    // Step 3: undefined - #input-password
    console.log('⚠️ Unknown step type: undefined');

    // Step 4: undefined - input[type='submit']
    console.log('⚠️ Unknown step type: undefined');

    // Step 5: undefined - .account-info
    console.log('⚠️ Unknown step type: undefined');

    // Step 6: undefined - h2
    console.log('⚠️ Unknown step type: undefined');

    console.log('✅ Test completed: Valid Login Test');
  });

  test('Invalid Email Format Test', async ({ page }) => {
    console.log('🧪 Starting test: Invalid Email Format Test');
    ...
    // Step 5: undefined - .alert-danger
    console.log('⚠️ Unknown step type: undefined');

    // Step 6: undefined - .alert-danger
    console.log('⚠️ Unknown step type: undefined');

    console.log('✅ Test completed: Invalid Email Format Test');
  });

  test('Empty Fields Test', async ({ page }) => {
    console.log('🧪 Starting test: Empty Fields Test');
    ...
    // Step 2: undefined - input[type='submit']
    console.log('⚠️ Unknown step type: undefined');

    // Step 3: undefined - .alert-danger
    console.log('⚠️ Unknown step type: undefined');

    // Step 4: undefined - .alert-danger
    console.log('⚠️ Unknown step type: undefined');

    console.log('✅ Test completed: Empty Fields Test');
  });
  ...
  test.afterEach(async ({ page }, testInfo) => {
    ...
    // Save execution data
    const dataPath = path.join(__dirname, 'b2b4bbba-4093-4db8-abff-7973eb2070b6-results.json');
    let results = [];
    try {
