...
test.describe('chandra', () => {
  ...
  test('Test Case 1', async ({ page }) => {
    ...
    await page.goto('https://todomvc.com/examples/jquery/', { waitUntil: 'networkidle' });
  ...
  test.afterEach(async ({ page }, testInfo) => {
    ...
    // Save execution data
    const dataPath = path.join(__dirname, 'f304c2ad-d24c-46e8-bf45-6d30a18a447d-results.json');
    let results = [];
    try {
